  ...
  return (
    <div className='flex flex-col gap-4'>
      ...
      <div className="border-1 border-neutral-200 bg-neutral-50 w-fit flex gap-3 items-center rounded-[3px] h-9 py-2 px-[6px]">
        <Button onClick={decreament} variant="ghost" disabled={count === 0} className="!p-0 w-5" size="icon">
          <SubtractIcon />
        </Button>
        <p className="text-neutral-600 font-medium text-sm w-[50px] text-center">{count}</p>
        <Button onClick={increament} variant="ghost" className="!p-0 w-5 h-5" size="icon">
          <PlusIcon />
        </Button>
      </div>
    </div>
